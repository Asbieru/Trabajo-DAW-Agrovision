/* ═══════════════════════════════════════════════════════════
   ...
   IA: Groq (API gratuita) — modelo llama3-8b-8192
   Modo híbrido: FAQ hardcodeado + Groq para el resto
   ═══════════════════════════════════════════════════════════ */

const AV_CHATBOT = (function () {

    // ── 🔑 AGREGA AQUÍ TUS API KEYS DE GROQ ─────────────────
    const GROQ_KEYS = [
        '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',  // cuenta SalazarStore
        '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',  // cuenta Salazr normal
        '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',  // cuenta Daniel Primo of
        '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',  // cuenta Daniel_pv
        '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',  // cuenta Leo de Jong
        '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'  // cuenta SoporteIchi
    ...
    const FAQ_GENERAL = [
        {
            patrones: ['que es agrovision', 'agrovision', 'para que sirve', 'sistema', 'de que trata'],
        ...
        {
            patrones: ['cerrar sesion', 'salir', 'logout', 'como salgo', 'como cierro'],
        ...
        {
            patrones: ['contrasena', 'password', 'olvide', 'cambiar clave', 'recuperar'],
        ...
        {
            patrones: ['hola', 'buenas', 'buenos dias', 'buenas tardes', 'hey', 'saludos'],
            respuesta: null
        }
    ];
    ...
    const FAQ_POR_ROL = {
        soporte: [
            {
                patrones: ['nuevo ticket', 'crear ticket', 'abrir ticket', 'registrar ticket', 'como creo', 'como abro', 'quiero crear', 'quiero abrir', 'quiero registrar'],
            ...
            {
                patrones: ['ver tickets', 'mis tickets', 'estado ticket', 'estados', 'listar tickets', 'donde veo'],
            ...
            {
                patrones: ['tipo ticket', 'tipos de ticket', 'incidencia', 'peticion', 'consulta', 'diferencia'],
            ...
            {
                patrones: ['calificar', 'calificacion', 'estrellas', 'valorar', 'puntuar'],
            ...
            {
                patrones: ['cancelar ticket', 'anular ticket', 'eliminar ticket', 'borrar ticket'],
            ...
            {
                patrones: ['prioridad', 'urgente', 'critico', 'urgencia'],
            ...
            {
                patrones: ['resolver ticket', 'resuelvo', 'resolver', 'solucionar', 'atender ticket'],
            ...
            {
                patrones: ['proyecto', 'proyectos', 'ver proyectos', 'crear proyecto', 'nuevo proyecto'],
            ...
            {
                patrones: ['puedo hacer', 'que puedo', 'empezar', 'empiezo', 'inicio', 'ayuda', 'ayudar', 'como funciona'],
                respuesta: null
            }
        ],
        programador: [
            {
                patrones: ['resolver ticket', 'resuelvo', 'como resuelvo', 'atender ticket', 'solucionar ticket', 'resolver un ticket'],
            ...
            {
                patrones: ['ver proyectos', 'proyectos', 'listar proyectos', 'mis proyectos', 'donde veo proyectos'],
            ...
            {
                patrones: ['sprint', 'sprints', 'que es un sprint', 'que son los sprints'],
            ...
            {
                patrones: ['nueva actividad', 'crear actividad', 'registrar actividad', 'actividad', 'como creo una actividad', 'quiero crear una actividad'],
            ...
            {
                patrones: ['story points', 'puntos', 'estimacion', 'esfuerzo'],
            ...
            {
                patrones: ['avance proyecto', 'avances', 'registrar avance', 'progreso'],
            ...
            {
                patrones: ['nuevo proyecto', 'crear proyecto', 'quiero crear un proyecto', 'quiero crear proyecto', 'abrir proyecto'],
            ...
            {
                patrones: ['aprobar proyecto', 'aprobacion', 'rechazar proyecto'],
            ...
            {
                patrones: ['usuarios', 'lista usuarios', 'gestionar usuarios', 'ver usuarios'],
        ...
        admin: [
            {
                patrones: ['aprobar proyecto', 'aprobacion', 'rechazar proyecto', 'como apruebo', 'revisar proyectos'],
            ...
            {
                patrones: ['nuevo proyecto', 'crear proyecto', 'registrar proyecto', 'quiero crear un proyecto', 'quiero crear proyecto'],
            ...
            {
                patrones: ['gestionar usuarios', 'lista usuarios', 'usuarios', 'ver usuarios', 'buscar usuario'],
            ...
            {
                patrones: ['indicadores', 'kpi', 'metricas', 'estadisticas'],
            ...
            {
                patrones: ['aplicaciones', 'gestionar aplicaciones', 'nueva aplicacion', 'apps'],
        ...
        agente: [
            {
                patrones: ['mis tickets', 'tickets asignados', 'ver mis tickets', 'donde veo'],
            ...
            {
                patrones: ['proyecto', 'proyectos', 'indicadores', 'reportes', 'usuarios'],
    ...
    function buildSystemPrompt(usuario) {
        ...
        const base = `Eres AgroBot, el asistente virtual de AGROVISION, un sistema de gestión empresarial.
...
Puede: Dashboard, gestionar todos los tickets, resolver tickets, aplicaciones, nuevo proyecto, ver proyectos, aprobación de proyectos, nueva actividad, indicadores KPI, lista de usuarios, reportes Excel.`,
            programador: `
ROL PROGRAMADOR — acceso parcial:
Puede: Dashboard, crear ticket, ver sus tickets, resolver tickets asignados a él, ver proyectos donde participa, nueva actividad.
NO puede: Crear/aprobar proyectos, ver aplicaciones, indicadores, reportes, lista de usuarios.`,
            soporte: `
ROL SOPORTE — acceso básico:
Puede: Dashboard, crear tickets, ver sus propios tickets, calificar tickets resueltos, cancelar sus tickets.
...
Puede: Ver tickets asignados a él, resolver tickets asignados.
NO puede: Proyectos, actividades, aplicaciones, indicadores, reportes, usuarios.`
    ...
    function buscarEnFAQ(texto, rol) {
        ...
        if (['hola','buenas','buenos dias','buenas tardes','hey','saludos'].some(p => t.includes(p)))
            return { tipo: 'dinamico', subtipo: 'saludo' };
 
        if (['puedo hacer','que puedo','como empiezo','por donde','empezar','como funciona'].some(p => t.includes(p)))
    ...
    async function llamarGroq(pregunta, usuario) {
        ...
        if (!keysValidas.length)
            return '⚠️ No hay API Keys configuradas. Agrega tus keys de Groq en <strong>chatbot.js</strong>.';
        ...
        while (groqKeyIndex < keysValidas.length) {
            ...
            try {
                ...
                // Límite de tasa → probar siguiente key
                ...
                // Error de red u otro → probar siguiente key
                groqKeyIndex++;
            }
        }
